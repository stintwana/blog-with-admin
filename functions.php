...
function getPublishedPosts() {
	...
	global $db;
	$sql = "SELECT * FROM posts  JOIN users ON posts.user_id=users.id WHERE published=true";
...
function getPost($slug){
	...
	$sql = "SELECT * FROM posts JOIN users ON posts.user_id=users.id WHERE slug='$post_slug' AND published=true";
	$result = mysqli_query($db, $sql);
